...
class AppRouter {
  late final GoRouter router = GoRouter(
    initialLocation: AppRoutes.guestSplash,//guestSplash,//forgetPasswordOtp,//otpReviewInvoicePostPaidScreen,//otpAutoRenewPrepaidScreen,//otpProfilePrepaidScreen, // initial Screen
