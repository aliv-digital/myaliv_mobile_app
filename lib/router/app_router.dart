...
class AppRouter {
  late final GoRouter router = GoRouter(
    initialLocation: AppRoutes.whyAliv,//guestPurchasePlanConfirmation,//confirmTopUpPrepaidScreen,//confirmTopUpPrepaidScreen,//.addOrEditCardsPrepaidScreen, // initial Screen
