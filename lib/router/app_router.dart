...
class AppRouter {
  late final GoRouter router = GoRouter(
    initialLocation: AppRoutes.loginOtp,//guestPurchasePlanConfirmation,//confirmTopUpPrepaidScreen,//confirmTopUpPrepaidScreen,//.addOrEditCardsPrepaidScreen, // initial Screen
