...
class AppRouter {
  late final GoRouter router = GoRouter(
    initialLocation: AppRoutes.guestSplash,//guestPurchasePlanConfirmation,//confirmTopUpPrepaidScreen,//confirmTopUpPrepaidScreen,//.addOrEditCardsPrepaidScreen, // initial Screen
