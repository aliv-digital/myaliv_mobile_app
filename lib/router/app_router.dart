...
class AppRouter {
  late final GoRouter router = GoRouter(
    initialLocation: AppRoutes.logIn,//guestPurchasePlanConfirmation,//confirmTopUpPrepaidScreen,//confirmTopUpPrepaidScreen,//.addOrEditCardsPrepaidScreen, // initial Screen
