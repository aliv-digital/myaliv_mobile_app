...
class AppRouter {
  late final GoRouter router = GoRouter(
    initialLocation: AppRoutes.createPassword,//guestPurchasePlanConfirmation,//confirmTopUpPrepaidScreen,//confirmTopUpPrepaidScreen,//.addOrEditCardsPrepaidScreen, // initial Screen
