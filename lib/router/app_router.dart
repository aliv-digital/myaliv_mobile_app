...
class AppRouter {
  late final GoRouter router = GoRouter(
    initialLocation: AppRoutes.logIn, //guestSplash,//forgetPasswordOtp,//otpReviewInvoicePostPaidScreen,//otpAutoRenewPrepaidScreen,//otpProfilePrepaidScreen, // initial Screen
