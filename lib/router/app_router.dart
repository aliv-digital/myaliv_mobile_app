...
class AppRouter {
  late final GoRouter router = GoRouter(
    initialLocation: AppRoutes.revBillPayPrepaidScreen, //guestSplash,//forgetPasswordOtp,//otpReviewInvoicePostPaidScreen,//otpAutoRenewPrepaidScreen,//otpProfilePrepaidScreen, // initial Screen
