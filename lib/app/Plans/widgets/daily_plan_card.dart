        ...
        children: [
          ...
          Row(
            children: [
              ...
              HomePlanPricePill(price: plan.price),
            ],
          ),
          ...
          HomePlanBenefitsRow(benefits: plan.benefits),
...
class HomePlanPricePill extends StatelessWidget {
  final double price;
  const HomePlanPricePill({super.key, required this.price});
...
class HomePlanBenefitsRow extends StatefulWidget {
  final List<HomePlanBenefit> benefits;
  const HomePlanBenefitsRow({super.key, required this.benefits});

  @override
  State<HomePlanBenefitsRow> createState() => _HomePlanBenefitsRowState();
}

class _HomePlanBenefitsRowState extends State<HomePlanBenefitsRow> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
                ...
                return Row(
                  children: [
                    SizedBox(
                      width: 112,
                      height: 66,
                      child: HomePlanBenefitItem(benefit: b),
                    ),
        ...
        const SizedBox(height: 10),
        HomePlanScrollIndicator(controller: _controller),
      ],
    );
  }
}
...
class HomePlanScrollIndicator extends StatelessWidget {
  final ScrollController controller;
  const HomePlanScrollIndicator({super.key, required this.controller});
...
// ===== Benefit item =====
class HomePlanBenefitItem extends StatelessWidget {
  final HomePlanBenefit benefit;
  const HomePlanBenefitItem({super.key, required this.benefit});
    ...
    return Row(
      ...
      children: [
        Padding(
          ...
          child: HomePlanAssetIcon(type: benefit.type, size: 16),
        ),
        const SizedBox(width: 6),
        Expanded(
          child: Padding(
...
class HomePlanAssetIcon extends StatelessWidget {
  final HomePlanBenefitType type;
  final double size;

  const HomePlanAssetIcon({super.key, required this.type, required this.size});
