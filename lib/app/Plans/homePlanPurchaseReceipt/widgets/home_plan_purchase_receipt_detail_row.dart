...
class HomePlanPurchaseReceiptDetailRow extends StatelessWidget {
  const HomePlanPurchaseReceiptDetailRow({
    super.key,
    required this.label,
    required this.value,
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontFamily: 'CircularPro',
              color: HomePlanPurchaseReceiptTheme.successCardValueTextBlack,
