              ...
              builder: (context, constraints) {
                return SingleChildScrollView(
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Align(
                      alignment: widget.benefits.length == 1 ? Alignment.center : Alignment.centerLeft,
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: List.generate(widget.benefits.length, (i) {
                          final RoamEasyPlanBucketModel item = widget.benefits[i];
                          Color labelColor;
                          BucketItemType itemType = BucketItemType.data;
                          ...
                          if (item.bucketUnit == 'INS_Data' && item.unit == 'GB') {
                            ...
                            itemType = BucketItemType.data;
                          } else if (item.bucketUnit == 'INS_Data_roam_UK_Europe' && item.unit == 'GB') {
                            itemType = BucketItemType.data;
                          } else if (item.bucketUnit == 'INS_SMS_Roam_UK_Europe' && item.unit == 'Text') {
                            itemType = BucketItemType.internationalSMS;
                          } else if (item.bucketUnit == 'INS_Voice_Roam_UK_Europe' && item.unit == 'Minutes') {
                            itemType = BucketItemType.call;
