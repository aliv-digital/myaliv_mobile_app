    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          Text(
            'freedom15\n7 days plan',
            style: TextStyle(fontFamily: 'CircularPro', color: Colors.white),
          ),
        ],
      ),
    );
    ...
    return _section(
      ...
      child: Padding(
        ...
        child: GridView.count(
          ...
          mainAxisSpacing: 12,
          children: const [
            ActionTile('assets/icons/ListStar.svg', 'buy plans'),
            ActionTile('assets/icons/ListHeart.svg', 'my future plans'),
            ActionTile('assets/icons/At.svg', 'update email'),
            ActionTile('assets/icons/UsersThree.svg', 'refer a friend'),
            ActionTile('assets/icons/aliv.svg', 'ALIV deals'),
