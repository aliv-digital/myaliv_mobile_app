      ...
      children: [
        InkWell(
          ...
          borderRadius: BorderRadius.circular(
            RoamingPlanConfirmationTheme.termsNoticeCheckboxRadius,
          ),
          child: Padding(
            padding: const EdgeInsets.only(
              top: RoamingPlanConfirmationTheme.termsNoticeCheckboxTopOffset,
            ),
            child: Container(
              width: RoamingPlanConfirmationTheme.termsNoticeCheckboxSize,
              height: RoamingPlanConfirmationTheme.termsNoticeCheckboxSize,
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  width: 1,
                  color: RoamingPlanConfirmationTheme
              ...
              child: widget.isChecked
                  ? const Icon(
                      Icons.check_rounded,
                      color: Colors.white,
                      size: RoamingPlanConfirmationTheme
        ...
        const SizedBox(
          width: RoamingPlanConfirmationTheme.termsNoticeCheckboxToTextGap,
        ),
        Flexible(
          child: ConstrainedBox(
            constraints: const BoxConstraints(
              maxWidth: RoamingPlanConfirmationTheme.termsNoticeTextWidth,
            ),
            child: Text.rich(
              TextSpan(
                children: [
                  TextSpan(
                    ...
                    style:
                        RoamingPlanConfirmationTheme.termsNoticeBodyTextStyle,
                  ),
                  TextSpan(
                    text: 'Terms & Conditions.',
                    style:
                        RoamingPlanConfirmationTheme.termsNoticeLinkTextStyle,
