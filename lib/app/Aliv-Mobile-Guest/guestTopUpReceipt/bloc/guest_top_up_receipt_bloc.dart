...
class GuestTopUpReceiptBloc
    extends Bloc<GuestTopUpReceiptEvent, GuestTopUpReceiptState> {
  final GuestTopUpReceiptRepository repository;

  GuestTopUpReceiptBloc({required this.repository})
    : super(GuestTopUpReceiptState.initial()) {
