import 'face_id_security_repository.dart';

class FaceIdSecurityRepositoryImpl implements FaceIdSecurityRepository {
  @override
  Future<FaceIdSecurityContent> fetchContent() async {
    // Demo static (replace with API later)
    return const FaceIdSecurityContent(
