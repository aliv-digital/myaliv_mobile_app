...
class ForgetPasswordOtpGradients {
  // Gradient used when OTP box is focused.
  static const LinearGradient focusedInputBorder = LinearGradient(
    begin: Alignment.centerLeft,
    end: Alignment.centerRight,
    colors: <Color>[
      ForgetPasswordOtpColors.focusedInputBorderYellow,
      ForgetPasswordOtpColors.focusedInputBorderBlue,
      ForgetPasswordOtpColors.focusedInputBorderPurple,
      ForgetPasswordOtpColors.focusedInputBorderPink,
      ForgetPasswordOtpColors.focusedInputBorderOrange,
    ],
  );
}

class ForgetPasswordOtpPaddings {
  // Shared horizontal padding for OTP content column.
  static const EdgeInsets contentHorizontal = EdgeInsets.symmetric(
    horizontal: ForgetPasswordOtpSizes.contentHorizontalPadding,
  );
}

class ForgetPasswordOtpMotion {
...
class ForgetPasswordOtpTheme {
  ...
  static const TextStyle title = TextStyle(
    ...
    color: ForgetPasswordOtpColors.textBlack,
  );
  ...
  static const TextStyle helperText = TextStyle(
    ...
    fontFamily: AppConstants.defaultFontFamily,
    height: 1.43,
    color: ForgetPasswordOtpColors.helperTextDark,
  );

  // Resend action text: "resend code" / "sending..."
  static const TextStyle resendText = TextStyle(
    color: ForgetPasswordOtpColors.actionLinkPurple,
    fontSize: 13,
    fontWeight: FontWeight.w700,
    fontFamily: AppConstants.defaultFontFamily,
