        ...
        return Column(
          ...
          children: [
            CustomCountryPhoneInputRow(
              ...
              unfocusedBorderColor: state.phoneFieldError
                  ? ForgetPasswordColors.errorRed
                  : ForgetPasswordColors.fieldBorder,
            ...
            if (state.phoneFieldError && state.errorMessage != null) ...[
              const SizedBox(height: 6),
              Padding(
                padding: EdgeInsets.only(
                  left: ForgetPasswordSizes.countryWidth +
                      ForgetPasswordSizes.countryToPhoneGap +
                      ForgetPasswordPaddings.fieldHorizontal14.left,
                ),
                child: Text(
                  state.errorMessage!,
                  style: ForgetPasswordTheme.phoneError,
                ),
              ),
            ],
          ],
