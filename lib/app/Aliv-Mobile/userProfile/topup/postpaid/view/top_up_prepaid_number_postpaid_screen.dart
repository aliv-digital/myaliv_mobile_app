...
class TopUpPrepaidNumberPostPaid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) =>
          TopUpPrepaidNumberPostPaidBloc()
    ...
    >(
      ...
      listener: (context, state) {
        if (state.applyStatus ==
                TopUpPrepaidNumberPostPaidApplyStatus.failure &&
            state.errorMessage != null) {
          AppToast.show(message: state.errorMessage!, type: ToastType.error);
        }
        if (state.applyStatus ==
            TopUpPrepaidNumberPostPaidApplyStatus.success) {
                    ...
                    slivers: [
                      SliverAppBar(
                        ...
                        title: const Text(
                          ...
                          style: TextStyle(
                            fontFamily:
                                TopUpPrepaidNumberPostPaidTheme.fontFamily,
                            color: Colors.white,
                            fontSize: 16,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                TopUpPrepaidNumberPostPaidApplySection(
                                  ...
                                  loading:
                                      state.applyStatus ==
                                      TopUpPrepaidNumberPostPaidApplyStatus
                                          .loading,
                                  onTap: () => bloc.add(
