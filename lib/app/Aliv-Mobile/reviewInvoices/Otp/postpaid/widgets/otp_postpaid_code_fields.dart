...
class OTPPostpaidCodeFields extends StatefulWidget {
  const OTPPostpaidCodeFields({super.key});

  @override
  State<OTPPostpaidCodeFields> createState() => _OTPPostpaidCodeFieldsState();
}
...
class _OTPPostpaidCodeFieldsState extends State<OTPPostpaidCodeFields> {
  ...
  void _onChanged(int index, String value) {
    ...
    context.read<OTPPostpaidBloc>().add(OTPPostpaidCodeChanged(code));
  }
