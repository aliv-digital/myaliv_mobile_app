...
class MakePaymentConfirmationPostPaidTheme {
  ...
  static const Color amountPillBg = Color(0xFFF3F3F6);
  ...
  static const EdgeInsets amountPillPadding = EdgeInsets.symmetric(
    horizontal: 10,
    vertical: 4,
  );

  // Header card spacing (Figma-aligned).
  static const EdgeInsets headerTopSectionPadding = EdgeInsets.fromLTRB(
    16,
    14,
    16,
    14,
  ...
  static const EdgeInsets headerBottomSectionPadding = EdgeInsets.fromLTRB(
    16,
    10,
    16,
    20,
