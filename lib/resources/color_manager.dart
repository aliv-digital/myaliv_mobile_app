...
class ColorManager{
  ...
  // Aliv -------------- starts --------------------
  static Color splashScreenTop = HexColor.fromHex('#FF625390');
  ...
  static Color buttonColor = HexColor.fromHex('#625290');

  static Color primaryDark = HexColor.fromHex('#464a53');
  static Color primaryBlack = HexColor.fromHex('#111827');
  static Color primaryGray = HexColor.fromHex('#374151');
